...
.span-subject {
    overflow: hidden; white-space: nowrap; max-width: 35vw; display: inline-flex;
 }
</style>
...
<div class="site-contact">
    ...
    <h1 style="position: relative;">
        <span>Inbox</span>
        <span class="span-counter" style="right: 200px"><i class="fa fa-inbox"></i> &nbsp; <a href="/mail/outbox">Outbox</a></span>
